---
title: "CI"
description: "Install your project\u2019s Flutter version and run checks in CI."
---
...
Replace `3.44.0` with the version in your project's `.fvmrc`. Run the Flutter commands from the checked-out project directory. For Windows runners, use the [Windows installation steps](/#install-fvm-on-windows).
